...
import {
  ...
  DivForm,
  InputImageLabel,
} from "../CadastroSorteios/Styles";
import { TelaEdicao } from "./Styles";

export const EditarSorteio = (props) => {
  const { listaSorteios } = React.useContext(ListaCotasContext);

  console.log(listaSorteios);
  const [getSorteio, setSorteio] = useState({});
    ...
    <>
      ...
      <CardCollapsed className="card card-body">
        <Row className="d-flex justify-content-center">
          ...
          <TelaEdicao className={showTable ? "showDiv" : ""}>
          ...
          <TelaEdicao className={showEdit ? "showDiv" : ""}>
            <Col sm={8}>
